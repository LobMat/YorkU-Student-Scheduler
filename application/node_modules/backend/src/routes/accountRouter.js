...
const {registerAccountController, loginController, verifyIDController, storePrefsController, getFriendsController, sendFriendRequestController} = require('../controllers/AccountController');
