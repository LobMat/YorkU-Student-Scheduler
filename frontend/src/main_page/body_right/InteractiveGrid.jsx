...
// 'InteractiveGrid.jsx' : React component containing the grid part of a schedule. and the activities.
// Re-rendered when an activity changes, remapping everything.

const populateMatrix = (activities) => {
